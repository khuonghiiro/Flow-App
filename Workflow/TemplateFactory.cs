...
namespace FlowMy.Workflow
{
    public sealed class TemplateFactory
    {
        ...
        private WorkflowNode CreateImageProcessingNode(double x, double y)
        {
            ...
            node.DynamicOutputs.Add(new WorkflowDynamicDataPort { Key = "cropListObjects", DisplayName = "Layer AI - Crops List Objects (JSON)", IsMultiple = true, OutputType = WorkflowDataType.ArrayDynamic });
        ...
        private WorkflowNode CreateVideoProcessingNode(double x, double y)
        {
            var node = new VideoProcessingNode
            {
                ...
                ColorKey = "CharcoalDark",
                IconSize = 32,
                NodeBrush = Application.Current.TryFindResource("CharcoalDarkBrush") as Brush ?? Brushes.DimGray,
