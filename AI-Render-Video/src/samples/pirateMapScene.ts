...
export const pirateMapScene: MasterSceneConfig = {
  scene_id: 'scene_pirate_adventure',
  title: '🏴‍☠️ Đảo Hải Tặc Phiêu Lưu (Map game_pirate_adventure_map.glb)',
  fps: 60,
  duration: 20.0,
  environment: {
    map: 'assets/maps/game_pirate_adventure_map.glb',
    sky_time: 'sunset',
    weather: {
      fog: 0.0005,
      wind: 0.2,
  ...
  dialogues_manifest: [
    {
      line_id: 'dlg_pirate_01',
      speaker_id: 'actor_warrior',
      speaker_name: 'Chiến Binh Thám Hiểm',
      speaker_color: '#38bdf8',
      text: 'Chúng ta đã chính thức cập bến Đảo Hải Tặc trong truyền thuyết!',
    ...
    {
      line_id: 'dlg_pirate_02',
      speaker_id: 'actor_anime_girl',
      speaker_name: 'Tiểu Vũ Hoa Tiêu',
      speaker_color: '#f472b6',
      text: 'Nhìn kìa, chiến hạm hải tặc và hòn đảo nhiệt đới này thật kỳ vĩ!',
    ...
    {
      line_id: 'dlg_pirate_03',
      speaker_id: 'actor_dark_mage',
      speaker_name: 'Thuyền Trưởng Hắc Ám',
      speaker_color: '#a855f7',
      text: 'Dừng bước! Muốn đụng vào kho báu thì phải bước qua lưỡi kiếm của ta!',
    ...
    {
      line_id: 'dlg_pirate_04',
      speaker_id: 'actor_warrior',
      speaker_name: 'Chiến Binh Thám Hiểm',
      speaker_color: '#38bdf8',
      text: 'Hãy tiếp chiêu đi, tên cướp biển hung tợn!',
  ...
  actors: [
    {
      id: 'actor_warrior',
      name: 'Chiến Binh Thám Hiểm',
      model: 'characters/hero_knight.vrm',
      spawn_point: [-1.5, 0, 3.5],
      tracks: {
        movement: [
          {
            start: 0.0,
    ...
    {
      id: 'actor_anime_girl',
      name: 'Tiểu Vũ Hoa Tiêu',
      model: 'assets/characters/sample_avatar.vrm',
      spawn_point: [1.5, 0, 4.0],
      tracks: {
        movement: [
          {
            start: 0.0,
