...
MOTION: Glancing eye spins with cartoon dizzy spiral (@), brows crooked and shaking, mouth line wobbling in dizzy bewilderment. Seamless loop.`,
  ...
  { id: 'face_funny', title: 'Hài Hước (Mặc định 0°)', subtitle: 'Alias 0°', stepCategory: 'step4_face', stepLabel: 'Bước 4', icon: '🤪', promptType: 'video', generationMode: 'image_to_video', aspectRatio: '9:16', tags: ['face', 'funny'], negativePrompt: '', infoNote: '', rawPrompt: 'TASK: Refer to face_0_funny' },
  { id: 'face_sinister', title: 'Nham Hiểm (Mặc định 0°)', subtitle: 'Alias 0°', stepCategory: 'step4_face', stepLabel: 'Bước 4', icon: '😈', promptType: 'video', generationMode: 'image_to_video', aspectRatio: '9:16', tags: ['face', 'sinister'], negativePrompt: '', infoNote: '', rawPrompt: 'TASK: Refer to face_0_sinister' },
  { id: 'face_mysterious', title: 'Bí Hiểm (Mặc định 0°)', subtitle: 'Alias 0°', stepCategory: 'step4_face', stepLabel: 'Bước 4', icon: '🎭', promptType: 'video', generationMode: 'image_to_video', aspectRatio: '9:16', tags: ['face', 'mysterious'], negativePrompt: '', infoNote: '', rawPrompt: 'TASK: Refer to face_0_mysterious' },
  { id: 'face_disdain', title: 'Khinh Bỉ (Mặc định 0°)', subtitle: 'Alias 0°', stepCategory: 'step4_face', stepLabel: 'Bước 4', icon: '😒', promptType: 'video', generationMode: 'image_to_video', aspectRatio: '9:16', tags: ['face', 'disdain'], negativePrompt: '', infoNote: '', rawPrompt: 'TASK: Refer to face_0_disdain' },
  { id: 'face_dizzy', title: 'Choáng Váng (Mặc định 0°)', subtitle: 'Alias 0°', stepCategory: 'step4_face', stepLabel: 'Bước 4', icon: '😵', promptType: 'video', generationMode: 'image_to_video', aspectRatio: '9:16', tags: ['face', 'dizzy'], negativePrompt: '', infoNote: '', rawPrompt: 'TASK: Refer to face_0_dizzy' },
];
