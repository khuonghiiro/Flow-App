...
export const LEFT_WING_SLOTS: EquipSlotItem[] = [
  { slot: 'toc_truoc', label: 'Tóc Mái', subLabel: 'Mái trước', icon: '💇', zDefault: 7 },
  { slot: 'dau', label: 'Khung Đầu', subLabel: 'Mặt/Cằm', icon: '👤', zDefault: 5 },
  { slot: 'mat', label: 'Cặp Mắt', subLabel: 'Biểu cảm', icon: '👀', zDefault: 6 },
  { slot: 'mieng', label: 'Khẩu Hình', subLabel: 'Lip-sync', icon: '👄', zDefault: 6 },
];

export const RIGHT_WING_SLOTS: EquipSlotItem[] = [
  { slot: 'toc_sau', label: 'Tóc Sau', subLabel: 'Tóc dài', icon: '💇', zDefault: 1 },
  { slot: 'trang_phuc', label: 'Trang Phục', subLabel: 'Đạo bào/Áo', icon: '👕', zDefault: 4 },
  { slot: 'than_co_ban', label: 'Thân Mình', subLabel: 'Trụ thân', icon: '🧍', zDefault: 3 },
  { slot: 'vu_khi', label: 'Vũ Khí', subLabel: 'Phi kiếm/Cụ', icon: '⚔️', zDefault: 8 },
];
