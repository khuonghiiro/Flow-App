// JSON Project Exporter, Importer & Default Multi-Angle Project Templates with Cinematic Art
import { Director2DProject, StandardHorizontalAngle, STANDARD_8_ANGLES, TOP_DOWN_ANGLES, LayerPartConfig } from '../../../../types/studio2d_director';
...
export function generateAngleSvgSample(charName: string, color: string, angle: StandardHorizontalAngle): string {
  ...
  if (isTopDown) {
    ...
    const svg = `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 140 200" width="140" height="200">
        ...
        <!-- Broad Shoulders & Robe (Top-Down Foreshortened) -->
  ...
  // Horizontal Angles (0° Front, 45° 3/4, 90° Side, 135° 3/4 Back, 180° Back)
...
/**
 * Creates default sample multi-angle sprites for a character (all 8 horizontal + top-down)
 */
...
/**
 * Built-in Sample Project with Multi-Angle Reverse Shot Dialogue and Cinematic Donghua Easing
 */
  ...
  shots: [
    {
      ...
      camera: {
        ...
        pitchEnd: 0,
        zoomStart: 1.05,
        zoomEnd: 1.3, // Cinematic smooth push-in
        panStart: [-70, 0],
        panEnd: [-90, -20],
        shakeIntensity: 0.0,
      },
      actors: {
        char_tieu_dao: {
          ...
          worldFacingAngle: 0, // Faces Camera
        ...
        char_hac_y: {
          actorId: 'char_hac_y',
          worldFacingAngle: 180, // Over-the-shoulder foreground silhouette
    ...
    },
    {
      ...
      durationSeconds: 3.5,
      camera: {
        angleStart: 180, // Reverse Shot 180°
        angleEnd: 180,
        pitchStart: 0,
        pitchEnd: 0,
        zoomStart: 1.15,
        zoomEnd: 1.42, // Push-in on villain face
        panStart: [80, 0],
        panEnd: [60, -20],
        shakeIntensity: 0.0,
      },
      actors: {
        char_hac_y: {
          actorId: 'char_hac_y',
          worldFacingAngle: 180, // Front facing from reverse camera
          positionStart: [160, 40],
          positionEnd: [160, 40],
          scale: 1.65,
          zIndex: 10,
        ...
        char_tieu_dao: {
          actorId: 'char_tieu_dao',
          worldFacingAngle: 0, // Back facing from reverse camera
          positionStart: [-180, 70],
          positionEnd: [-180, 70],
          scale: 2.1,
          zIndex: 20,
    ...
    },
    {
      ...
      camera: {
        angleStart: 45,
        angleEnd: 45,
        pitchStart: 60, // Top-Down High Angle
        pitchEnd: 60,
        zoomStart: 1.25,
        zoomEnd: 1.6,
        panStart: [0, -30],
