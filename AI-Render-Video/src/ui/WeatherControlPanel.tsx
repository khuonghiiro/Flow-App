...
import { LightningControlSection } from './weather/LightningControlSection';
            ...
            {isRainEnabled ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginTop: 2 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  ...
                  <div style={{ fontSize: 9, color: '#94a3b8' }}>
                    {(override.rain_collision_quality ?? 2) === 0
                      ...
                      : (override.rain_collision_quality ?? 2) <= 2
                        ? '⚖️ Tiết kiệm — 3 raycasts/frame, đủ mượt cho card yếu'
                        : (override.rain_collision_quality ?? 2) <= 5
                          ? '🎯 Cân bằng — 18 raycasts/frame, bắt chi tiết nóc nhà & dốc'
                          : '💎 Chất lượng cao — 35 raycasts/frame, cực kỳ sắc nét'}
                  </div>
                  <input 
                    type="range" 
                    min="0" max="10" step="1"
                  ...
                  />
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 8, color: '#64748b' }}>
                    <span>0 Tắt (mưa xuyên thấu)</span>
                    <span>2 Mặc định</span>
                    <span>5 Cân bằng</span>
                    <span>10 Max Ultra</span>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 8, color: '#64748b' }}>
                    ...
                    <span>45m (mặc định)</span>
                    <span>100m (toàn map)</span>
                  </div>
                </div>

                {/* 3.3 SẤM CHỚP & TIA SÉT (LIGHTNING PRESETS & FINE-TUNING) */}
                <LightningControlSection override={override} onChange={onChange} />
              </div>
            ) : (
