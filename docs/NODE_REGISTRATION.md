...
> ⚠️ **QUAN TRỌNG — Tránh duplicate ports:**
> - **CHỈ tạo ports trong TemplateFactory** — ĐỪNG thêm ports trong Node Model constructor
> - Nếu thêm ports ở cả 2 chỗ → node sẽ có **2 port IN và 2 port OUT** (duplicate)
> - Template dưới đây là nơi DUY NHẤT để tạo ports cho node
...
private static WorkflowNode CreateYourNode(double x, double y)
{
    ...
    // ⚠️ Tạo ports CHỈ Ở ĐÂY — KHÔNG thêm ports trong Node Model constructor
