    ...
    public partial class WorkflowEditorWindow
    {
        ...
        private WorkflowNode? CreateDuplicateNodeInstance(WorkflowNode source, double offsetX, double offsetY)
        {
            ...
            else if (source is VideoProcessingNode srcVideo && node is VideoProcessingNode dstVideo)
            {
                ...
                dstVideo.VideoOutputFolderSourceNodeId = srcVideo.VideoOutputFolderSourceNodeId;
                dstVideo.VideoOutputFolderSourceOutputKey = srcVideo.VideoOutputFolderSourceOutputKey;
                dstVideo.AudioOutputFolderSourceNodeId = srcVideo.AudioOutputFolderSourceNodeId;
                dstVideo.AudioOutputFolderSourceOutputKey = srcVideo.AudioOutputFolderSourceOutputKey;
                ...
                dstVideo.ExtractFramesEnabled = srcVideo.ExtractFramesEnabled;
                dstVideo.ExportVideoEnabled = srcVideo.ExportVideoEnabled;
                dstVideo.ExtractAudioEnabled = srcVideo.ExtractAudioEnabled;
                ...
                dstVideo.AudioOutputFolderPath = srcVideo.AudioOutputFolderPath;
