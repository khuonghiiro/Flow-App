...
{
    public partial class DataConvertNodeDialog : BaseNodeDialog
    {
        private readonly DataConvertNodeDialogViewModel _viewModel;

        public DataConvertNodeDialog(DataConvertNode node, IWorkflowEditorHost host, Window? owner)
            : base()
        {
            InitializeComponent();
            _viewModel = new DataConvertNodeDialogViewModel(node, host);
